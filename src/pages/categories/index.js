...
function Categories() {
  ...
  const handleDelete = async (id) => {
    let alertDelete = Swal.fire({
      title: "Delete Category",
      text: "Are you sure you want to delete",
      showCancelButton: true,
      icon: "warning",
      confirmButtonColor: "red",
      confirmButtonText: "yaa delete",
      cancelButtonText: "batal",
      cancelButtonColor: "green",
    });
    if ((await alertDelete).isConfirmed) {
      ...
      dispatch(
        setNotif(
          true,
          "success",
          `berhasil hapus data dengan nama ${res.data.data.name}`
        )
      );
      dispatch(fetchCategories());
    }
...
//     const res = await deleteData(`/cms/categories/${id}`);
//     dispatch(
//       setNotif(true, "success", `berhasil hapus kategori ${res.data.data.name}`)
//     );
//     dispatch(fetchCategories());
//   }
// });
